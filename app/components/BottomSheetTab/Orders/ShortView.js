    ...
    <>
      <View style={{...styles.secondTableRow}}>
        <View
          ...
          <Text style={{fontWeight: '700', color: 'black'}}>Order Type</Text>
        </View>
        <View
          style={{
            ...styles.secondTableColum,
      ...
      <View style={{...styles.secondTableRow}}>
        ...
        <View
          style={{
            ...
            backgroundColor: item.Status == 'Completed' ? '#c6efcd' : '#e7c4b5',
          }}>
          <Text style={{fontWeight: '700', color: 'black'}}>{item.Status}</Text>
        </View>
      </View>
      <ColumView
      ...
      <ColumView
        title="Tech Contact"
        bgcolor="#f2f2f2"
        value={item.Technical_Contact_Name ? item.Technical_Contact_Name : '--'}
      />
      <ColumView
        title="Item#"
        bgcolor="#f2f2f2"
      ...
      <ColumView
        ...
        value={
          item.Monthly_Recurring_Cost ? `$${item.Monthly_Recurring_Cost}` : '--'
        }
      />
      <ColumView
        bgcolor="#e6eddd"
