...
const AllDevicesDetails = ({route, getAllDeviceDetails}) => {
            ...
            <ScrollView>
              ...
              {item?.System_Description ? (
                <View style={styles.secondTableRow}>
                  ...
                  <View style={styles.secondTableColum}>
                    <Text style={{fontWeight: '700', color: 'black'}}>
                      {item.System_Description.substr(1, 15)}...
                    </Text>
                  </View>
                </View>
              ) : null}
...
export default connect(null, {getAllDeviceDetails})(AllDevicesDetails);
